...
#> 
        ...
        $Job = $Jobs|Where-Object {$_.Name -eq 'DatabaseBackup - USER_DATABASES - FULL'}
        if ($Job -eq $Null) 
        {Write-Output "No Job with that name" 
        break}
        else{
        ...
        $Job = $Jobs|Where-Object {$_.Name -eq 'DatabaseBackup - USER_DATABASES - DIFF'}
        if ($Job -eq $Null) 
        {Write-Output "No Job with that name" 
        break}
        else{
        ...
        $Job = $Jobs|Where-Object {$_.Name -eq 'DatabaseBackup - USER_DATABASES - LOG'}
        if ($Job -eq $Null) 
        {Write-Output "No Job with that name" 
        break}
        else{
