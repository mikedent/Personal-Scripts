# Author: Mike Dent
# Modified slightly from William Lam's script at www.virtuallyghetto.com
...
SSO_ADMINISTRATOR_PASSWORD=Pdntsp@7

# Set Hostname
VCENTER_HOSTNAME=opd-vcenter.cad.local

# Enable NTP
ENABLE_NTP=0
NTP_SERVERS=10.10.92.19,10.10.92.20
