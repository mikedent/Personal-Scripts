...
# describes the function Deploy-LogInsight
Describe 'Deploy-LogInsight' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Deploy-LogInsight } | Should Not Throw
    }
    It 'does something' {
      # call function Deploy-LogInsight and pipe the result to an assertion
      # Example:
      # Deploy-LogInsight | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Deploy-LogInsight | Should BeNullOrEmpty 
    }
  }
}
